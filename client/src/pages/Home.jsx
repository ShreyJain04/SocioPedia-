            ...
            >
              <div className="w-full flex items-center gap-2 py-4 border-b border-[#66666645]">
                ...
                <TextInput
                  ...
                  placeholder="Got something to share? Here you go...."
                  name="description"
                  register={register("description", {
                    required: "Post descriptionis required",
                  })}
                ...
                <div>
                  {posting ? (
                    ...
                    <CustomButton
                      type="submit"
                      title="Post"
                      containerStyles="bg-[#87A922] text-white py-1 px-6 rounded-full font-semibold text-sm"
                    />
                  )}
                </div>
              </div>
