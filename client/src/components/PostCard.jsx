    ...
    >
      <div className="w-full flex items-center gap-2 py-4">
        ...
        <TextInput
          ...
          placeholder={
            replyAt ? `Reply @${replyAt}` : "Leave a comment on this post"
          }
      ...
      <div className="flex items-end justify-end pb-2">
        {loading ? (
          ...
          <CustomButton
            title="Submit"
            type="submit"
            containerStyles="bg-[#87A922] text-white py-1 px-3 rounded-full font-semibold text-sm"
          />
        )}
      </div>
    </form>
...
const PostCard = ({ post, user, deletePost, likePost }) => {
  ...
  return (
    <div className="mb-2 bg-primary p-4 rounded-xl">
      <div className="flex gap-3 items-center mb-2   px-2 py-2 border-b border-[#B4B4B8]">
        <Link to={"/profile/" + post?.userId?._id}>
          <img
            src={post?.userId?.profileUrl ?? NoProfile}
            alt={post?.userId?.firstName}
            className="w-12 h-12 md:w-14 md:h-14 object-cover rounded-full mx-2"
          />
        </Link>
      ...
      <div>
        ...
        {post?.image && (
          <img
            src={post?.image}
            alt="post image"
            className="w-full mt-2 rounded-lg border-2  border-[#B4B4B8]"
          />
        )}
      </div>
      ...
      text-base border-t border-[#B4B4B8]"
      >
        <p
              ...
              <div className="w-full py-2" key={comment?._id}>
                ...
                <div className="ml-12">
                  ...
                  <div className="mt-2 flex gap-6">
                    ...
                    <span
                      className="text-[#87A922] cursor-pointer"
